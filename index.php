...
<head>
    <meta charset="UTF-8">
    <title>CRUD - Flavia e Isabella Veras</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        ...
                        <a href="create.php" class="btn btn-success pull-right" title="Adicionar funcionário">+</a>
                    </div>
                    <?php
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            ...
                                            echo "<a href='update.php?id=". $row['id'] ."' title='Editar' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil'></span></a>";
